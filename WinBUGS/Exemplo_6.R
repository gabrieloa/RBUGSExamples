...
collected_sample <- bugs(data_model, inits, c('phi', 'sigma'),
                         'Experimento_6.txt', n.chains = 2, n.iter = 2000,
...
collected_sample <- bugs(data_model, inits, c('phi', 'sigma'),
                         'Experimento_6.txt', n.chains = 4, n.iter = 1500,
...
collected_sample <- bugs(data_model, inits, c('phi', 'sigma'),
                         'Experimento_6_1.txt', n.chains = 2, n.iter = 2000,
                         n.burnin = 0, bugs.directory = '/home/gabriel/Downloads/WinBUGS/',
                         debug = T, n.thin=1)
...
collected_sample <- bugs(data_model, inits, c('phi', 'sigma'),
                         'Experimento_6_1.txt', n.chains = 4, n.iter = 1500,
                         n.burnin = 500, bugs.directory = '/home/gabriel/Downloads/WinBUGS/', n.thin=1)
